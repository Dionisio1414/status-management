...
import parserIds from '@/status-management/utils/parser-ids';

import { API_STARK_URL, API_STARK_COMMENTS_URL } from '@/status-management/constants/api';
import {
...
} from '@/status-management/constants/store/product/mutation-types';

import { UPDATE_PRODUCT_ITEM } from '@/status-management/constants/store/product-list/action-types';
