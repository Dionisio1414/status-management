      ...
      <b-col>
        <div class="table-responsive table-responsive--radius">
          ...
          >
            ...
            <template #cell(article_id)="data">
              <div class="d-flex align-items-center" style="gap: 1rem">
                <b-button
                  v-if="data.item.articleId"
                  class="btn--default mr-auto"
                  variant="link"
                ...
                <div
                  v-else
                  class="mr-auto"
                  v-html="$options.filters.columnValue(data.item.id)"
                />
...
import PER_PAGE_TABLE from '@/status-management/constants/per-page-table';
import {
  UPDATE_TABLE,
...
import {
  ...
  MODAL_ROCK,
} from '@/status-management/constants/modals/modal-ids';
...
import { MODAL_SHOW } from '@/status-management/constants/modals/modal-event-types';
