...
import CharacteristicsTable from '@/status-management/components/characteristics-table.vue';

import { FIELDS_CHARACTERISTICS_TABLE } from '@/status-management/constants/fields-table';
import { MODAL_CLOSE } from '@/status-management/constants/modals/modal-event-types';

import { GET_PRODUCT_CHARACTERISTICS } from '@/status-management/constants/store/product/action-types';
